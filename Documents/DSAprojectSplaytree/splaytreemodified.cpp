...
{   
    ...
    line();
    cout<<"\n\t\t\tADSA PROJECT";
    cout<<"\t\t By Elizabeth Jees Tharayile 106121039 , Kavimalar Subbiah 106121059";
    cout<<"\n\n\n Splay trees are a widely-used data structure in diverse fields, from education and emergency services to law enforcement.";
    cout<<"\n\n Their clever design ensures that frequently accessed items are quickly available, making them an ideal choice for efficient information management.";
    cout<<"\n\n  In this project, we aim to develop a hospital management system utilizing splay trees. By implementing this advanced data structure, we can streamline and enhance the organization of critical patient data, resulting in improved patient care and optimized hospital operations.";
    line();
